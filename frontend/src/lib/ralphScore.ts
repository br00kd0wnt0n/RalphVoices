...
//
// Mirror of backend/src/utils/ralphScore.ts (the canonical copy, computed and
// stored in test_results.summary.ralph_score). The frontend only uses this as a
// fallback for tests completed before the score was stored, and for live progress.
// backend/tests/ralphScore.test.ts proves the two agree — keep them identical.
//
